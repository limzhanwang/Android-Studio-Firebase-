...
public class Profile extends AppCompatActivity {
    ...
    private Button btnChangePassword, btnSendResetEmail,
            changePassword, sendEmail, signOut, info ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Profile.this, updateuserinfo.class));
            }
        });
        ...
        bottomnavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch(menuItem.getItemId()){
                    ...
                    case R.id.nav_home:
                        Toast.makeText(Profile.this,"BMI calculator", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(Profile.this,BmiCalculator.class));
                        finish();
                    ...
                    case R.id.nav_account:
                        Toast.makeText(Profile.this,"Managed Account", Toast.LENGTH_SHORT).show();
                    ...
                    case R.id.nav_userinfo:
                        Toast.makeText(Profile.this,"Information Page", Toast.LENGTH_SHORT).show();
                    ...
                    case R.id.nav_guide:
                        Toast.makeText(Profile.this,"Guide Page", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(Profile.this,workout.class));
                        finish();
                        bottomnavigationView.findViewById(R.id.nav_userinfo).setVisibility(View.GONE);
                        bottomnavigationView.findViewById(R.id.nav_home).setVisibility(View.GONE);
                        bottomnavigationView.findViewById(R.id.nav_account).setVisibility(View.GONE);
